class Game {
    ...
    constructor(canvasId) {
      ...
      this.alvards = [
        ...
        new Alvard(this.ctx, this.mario.x + 1500, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 3317, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 5500, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 8311, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 10520, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 11531, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 13531, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 16531, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 17531, this.mario.y),
        new Alvard(this.ctx, this.mario.x + 18002, this.mario.y),
      ...
      this.kims = [
        new Kim(this.ctx, this.mario.x + 5600, this.mario.y - 20),
        new Kim(this.ctx, this.mario.x + 13700, this.mario.y),
      ]
  
  
      this.papers = [
        new Paper(this.ctx, this.mario.x + 5190, this.mario.y),
        new Paper(this.ctx, this.mario.x + 9400, this.mario.y),
        new Paper(this.ctx, this.mario.x + 14000, this.mario.y),
      ]
    ...
    checkCollisions() {
        ...
        if (this.drow) {
            this.drow = false
            this.drowGreade(610, 1)
            this.drowGreade(2011, 1)
            this.drowGreade(4254, 2)
            this.drowGreade(4875, 1)
            this.drowGreade(5789, 1)
            this.drowGreade(6608, 2)
            this.drowGreade(9523, 1)
            this.drowGreade(11066, 1)
            this.drowGreade(13066, 1)
            this.drowGreade(15066, 1)
            this.drowGreade(17876, 1)
    
          
            for (let i = 500; i < 24000; i += 1911) {
              this.drowCOIN(i);
            }
          }
