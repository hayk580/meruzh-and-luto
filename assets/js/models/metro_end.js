class Game {
    ...
    constructor(canvasId) {
      ...
      this.levels = {
        ...
        level_metro: './assets/img/Metro-04.png'
      }
      ...
      this.eskalator.src = './assets/img/Metro-05.png'
      let x = 0
      let y = 50
      this.mario.maxX = 1300
      this.bx = 0
      this.points = 0
      this.points = 0
    ...
    draw() {
      ...
      this.ctx.drawImage(this.background, this.bx, 0, 1375, 695)
      this.mario.draw()
      this.pointsCoin.draw()
      this.ctx.drawImage(this.eskalator, 935, 96 , 450, 400 )
      this.ctx.save()
    ...
    move() {
      ...
      if(this.mario.x < 370) {
        ...
        this.mario.move() 
          ...
          this.mario.move()
          if(this.mario.x >= 930 && this.mario.x < 1300) {
            this.mario.y -= 3.4
          }
          else if (this.mario.x >= 1300){
